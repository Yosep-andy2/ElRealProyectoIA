        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col gap-6">
                    ...
                    <div className="flex gap-3">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent w-full sm:w-72 transition-all"
                                value={searchTerm}
                ...
                {(showFilters || filterStatus !== 'all') && (
                    <div className="flex flex-col sm:flex-row gap-4 p-4 bg-white border border-gray-100 rounded-xl shadow-sm animate-slide-in">
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                ...
                                className="block w-full sm:w-48 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
                            >
