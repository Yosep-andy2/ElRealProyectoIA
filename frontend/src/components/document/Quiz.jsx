...
const Quiz = ({ documentId }) => {
        ...
        return (
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden mt-6">
                ...
                <div className="p-8 text-center">
                    ...
                    <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Ponte a prueba</h4>
                    ...
                    {error && (
                        <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm rounded-md flex items-center justify-center gap-2">
    ...
    if (status === 'loading') {
        return (
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden mt-6 p-12 text-center">
                <Loader2 className="w-10 h-10 text-indigo-600 dark:text-indigo-400 animate-spin mx-auto mb-4" />
                <h4 className="text-lg font-medium text-gray-900 dark:text-white">Preparando tu examen...</h4>
                <p className="text-gray-500 dark:text-gray-400">Analizando el documento y redactando preguntas.</p>
            </div>
        );
    }
    ...
    if (status === 'active') {
        ...
        return (
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden mt-6">
                ...
                <div className="p-6">
                    <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-6">{question.question}</h4>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden mt-6">
                ...
                <div className="p-6 space-y-8">
                    {questions.map((q, qIndex) => {
                        ...
                        return (
                            <div key={qIndex} className="border-b last:border-0 border-gray-100 dark:border-gray-700 pb-6 last:pb-0">
                                <div className="flex items-start gap-3 mb-3">
                                    ...
                                    <div>
                                        <h4 className="font-medium text-gray-900 dark:text-white">{q.question}</h4>
                                    </div>
                                </div>

                                <div className="ml-9 space-y-2">
                                    <div className="text-sm">
                                        <span className="font-medium text-gray-500 dark:text-gray-400">Tu respuesta: </span>
                                    ...
                                    {!isCorrect && (
                                        <div className="text-sm">
                                            <span className="font-medium text-gray-500 dark:text-gray-400">Respuesta correcta: </span>
                                            <span className="text-green-600 dark:text-green-400">{q.options[q.correct_answer]}</span>
                                        </div>
                                    )}

                                    <div className="mt-2 p-3 bg-gray-50 dark:bg-gray-700/50 rounded text-sm text-gray-600 dark:text-gray-300 border-l-4 border-indigo-200 dark:border-indigo-800">
                    ...
                    <div className="pt-6 flex justify-center">
                        <button
                            onClick={resetQuiz}
                            className="flex items-center gap-2 px-6 py-3 border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 font-medium"
                        >
